...
<input type="text" name="trade_code" class="form-control" placeholder="trade_code">
@error('trade_code')
<div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
@enderror
</div>
...
<div class="form-group">
<strong>High:</strong>
<input type="text" name="high" class="form-control" placeholder="">
@error('high')
<div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
@enderror
</div>
...
<div class="form-group">
<strong>low:</strong>
<input type="text" name="low" class="form-control" placeholder="">
@error('low')
<div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
@enderror
</div>
...
<div class="form-group">
<strong>close:</strong>
<input type="text" name="close" class="form-control" placeholder="">
@error('close')
<div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
@enderror
</div>
